...
SGN::View::Mason - Mason View Component for Cview

=head1 DESCRIPTION

Mason View Component for Cview. This extends Catalyst::View::HTML::Mason.

=cut

package Cview::View::Mason;
use Moose;
...
__PACKAGE__->config(
    ...
    interp_args => {
        data_dir => "/tmp/cview/",#SGN->tempfiles_base->subdir('mason'),
        comp_root => [
            [ main => Cview->path_to('mason') ],
        ],
    },
);
