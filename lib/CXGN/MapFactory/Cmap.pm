...
package CXGN::Cview::MapFactory::Cmap;
...
sub new {
    ...
    # at this point throw away the database handle which will be to a SGN postgresql database.
...
sub get_all_maps {
	...
	push @maps, $self->create({ map_version_id=>"cmap".$map_id} );
    }
    return @maps;
}
