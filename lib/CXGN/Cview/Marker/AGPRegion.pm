...
CXGN::Cview::Marker::AGPRegion - a class to draw markers that represent regions as defined in an AGP file

=head1 DESCRIPTION

CXGN::Cview::Marker::AGPRegion inherits from L<CXGN::Cview::Marker>.

my $m = CXGN::Cview::Marker::AGPRegion->new();
$m->set_offset(30);
...
package CXGN::Cview::Marker::AGPRegion;
